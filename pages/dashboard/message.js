...
import { ActiveStatus, Icons, Link, Mic, Sent } from "../../components/DashBoard/Message/MessageIcon";
            ...
            <div className="border rounded-lg flex">
                ...
                <div className="flex flex-col justify-between w-full">
                    <div className="relative flex items-center px-4 py-3 border-b">
                        <Image className="mask mask-squircle" src={faisal} alt="username" width={40} height={40} />
                    ...
                    <div className="relative px-4 py-3 overflow-y-auto">
                        <div className="chat chat-start">
                            <div className="chat-image avatar">
                                <Image className="mask mask-squircle" src={faisal} alt="" width={32} height={32} />
                            </div>
