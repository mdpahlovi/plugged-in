...
//                         aria-required
//                     />
//                     <button onClick={handleSubmit} className="btn btn-primary ml-0">
//                         <BiPlusMedical className="inline-block" /> Add
//                     </button>
//                 </form>
//                 <ul>
//                     {todoList.length >= 1
...
//                               return (
//                                   <li
//                                       className="flex justify-between items-center flex-1 rounded shadow text-grey-dark mr-2 text-center gap-2 bg-yellow-50 text-green-800"
//                                       key={idx}
//                                   >
//                                       {idx + 1} {todo}{" "}
//                                       <button
...
//                                               handleDelete(todo);
//                                           }}
//                                           className="mt-0 items-center btn btn-warning"
//                                       >
//                                           <RiDeleteBin2Fill className="inline-block" />
//                                           Delete
//                                       </button>
//                                   </li>
//                               );
