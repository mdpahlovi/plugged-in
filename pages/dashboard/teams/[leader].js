        ...
        return (
            <Teams title="Add Member">
                ...
                <div className="mt-6 grid xs:grid-cols-[repeat(auto-fill,_minmax(20.5rem,_1fr))] gap-6">
                    ...
                    <TaskDetailsModal team={team} selectedMemberTask={selectedMemberTask} />
                    {/* <SeeRewardModal
          ...
          /> */}
                    <SeeRewardModal selectedMemberTask={selectedMemberTask} seerewardMember={seerewardMember} />
                    <GiveRewardModal selectedMemberTask={selectedMemberTask} giveRewardMember={giveRewardMember} />
                </div>
            </Teams>
        );
    }
