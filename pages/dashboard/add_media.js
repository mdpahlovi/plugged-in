                ...
                <div className="grid grid-cols-1 space-y-2">
                    ...
                    {updatedMediaUrl ? (
                        ...
                        <label className="flex items-center rounded-lg border-4 border-dashed aspect-video group text-center">
                            ...
                            >
                                <Image className="h-36 object-center" src={theme === "light" ? Light : Dark} alt="" />
                                <h5>
                                    Drag and drop files here <br /> or <span className="font-bold text-primary hover:underline mr-1">select a file</span>
                                    from your computer
                                </h5>
                            </div>
