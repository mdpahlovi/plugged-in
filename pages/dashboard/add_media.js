...
const AddMedia = () => {
    ...
    const handleUploadMedia = (event, media) => {
        ...
        axios
            .post("https://api.cloudinary.com/v1_1/dkgx3tgyq/video/upload", media)
            .then((res) => {
                const media = {
                    date: new Date(),
                    ...
                    title: event.target.form.title,
                };
                axios
                    .post("https://plugged-in-server.onrender.com/userRecords", media)
                    .then((res) => {
