...
import chckImg from '../public/logo/Ecommerce checkout laptop-rafiki.png'
    ...
    return <Main title="Pricing - PluggedIn">
          <div className='container mx-auto px-4 py-8 rounded-lg shadow-md'>
              ...
              <div className='flex flex-col lg:flex-row gap-4 justify-center items-center'>
                <Image className='w-1/2' src={chckImg}/>
              <form>
                <div className="mt-10 bg-bage-100 px-4 pt-8 lg:mt-0">
                ...
                <button className="mt-4 mb-8 w-full rounded-md bg-gradient-to-br from-[#2F0D77] via-[#201172] to-[#816EEF] px-6 py-3 font-medium text-white">Place Order</button>
                </div>
