                ...
                <div className="mt-3 grid w-4/5 xs:w-auto xs:grid-cols-[auto_auto] gap-4">
                    {pendingStatus === "pending" ? (
                        ...
                        <div className="dropdown dropdown-bottom">
                            ...
                            <ul tabIndex={0} className="dropdown-content p-2 shadow bg-base-100 rounded-box">
                                <li>
                                    <Button className={"flex items-center"} onClick={handleAcceptRequest}>
                                ...
                                <li className="mt-2">
                                    <ButtonOutline>
                                        <label
                                            ...
                                            onClick={() => setDisconnectingFriend({ email, room: friend?.room })}
                                            className="flex items-center"
                                        >
