        ...
        >
          {roles.map(({ name, value }, index) => (
            <option
              key={index}
              value={value}
              selected={value === role ? true : false}
            >
              {name}
            </option>
          ))}
            ...
            {pendingStatus === "pending" ? (
                <td onClick={() => handleCancelConnect({ name, avatar, email, pendingRefetch })} className="hover:text-blue-500 cursor-pointer">
                ...
                <td onClick={() => handleConnect({ name, avatar, email, pendingRefetch })} className="hover:text-blue-500 cursor-pointer">
